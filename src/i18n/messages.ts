...
const ckb: Messages = {
  ...
  about: {
    ...
    p2: 'بەرهەمەکە بۆ ئەوانە دروست کراوە کە ستریم لە پەخشدا دەهێڵنەوە — نەک بۆ پێشکەشکردنی سلاید. Docker Compose سیستەمی PostgreSQL، API، پانێڵی React، و NGINX RTMP دەهێنێت بۆ ئەوەی لە ناوخۆ یان لەسەر VPS لە تەنیشت سێرڤەری میدیای هەبوو دایبمەزرێنیت.',
