...
const ckb: Messages = {
  ...
  hero: {
    tagline:
      'کۆنترۆڵی پەخشی خۆجێگیرکراو بۆ ئۆپەرەیتەرەکان کە پێویستیان بە کەناڵ، پلەیلیست، و تەلەڤیزیۆنی بەردەوامە — بەبێ ئاڵۆزی زیادە.',
  ...
  home: {
    ...
    ctaBody: 'ڕێنمایی هەنگاو-بە-هەنگاوی دامەزراندن شوێن بکەوە و لە چەند خولەکدا لەسەر localhost:8081 بیت.',
  ...
  about: {
    ...
    p2: 'بەرهەمەکە بۆ ئەوانە دروست کراوە کە ستریم لەسەر هەوا دەهێڵنەوە — نەک بۆ پێشکەشکردنی سلاید. Docker Compose سیستەمی PostgreSQL، API، پانێڵی React، و NGINX RTMP دەهێنێت بۆ ئەوەی لە ناوخۆ یان لەسەر VPS لە تەنیشت سێرڤەری میدیای هەبوو دایبمەزرێنیت.',
    p3: 'پۆرتە بنەڕەتییەکان لە ڕێگای ستاکە باوەکان دوور دەکەونەوە (HTTP 8081، RTMP 1936). ڕێکخستنە بنەڕەتییەکان زوو دەتهێننە ژوورەوە؛ Settings و گۆڕاوەکانی ژینگە دامەزراندن بۆ پرۆداکشن بەهێز دەکەن.',
    ...
    members: [
      {
        ...
        bio: 'سەرکردایەتی کوردلۆگز کۆر دەکات لە سەرەتاوە تا کۆتایی — ئاراستەی بەرهەم، ئەزموونی ئۆپەرەیتەر، و ستاکی خۆجێگیرکراو کە کەناڵ لەسەر هەوا دەهێڵێتەوە.',
      },
      {
        name: 'تیمی کوردلۆگز',
  ...
  faq: {
    ...
    stillTitle: 'هێشتا خەریکی دامەزراندنیت؟',
    stillBody:
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Docker و Docker Compose (هەروەها Git بۆ کلۆنکردنی ڕێپۆ). لەسەر Windows/macOS دۆکەر دێسکتۆپ دابەزێنە؛ لەسەر Linux دۆکەر ئێنجن دابمەزرێنە. پەڕەی بەڵگەنامە لینکی ڕاستەوخۆی هەیە. ستاکەکە PostgreSQL، API، پانێڵ، و NGINX RTMP لەخۆدەگرێت.',
      },
      {
    ...
    requirements: [
      {
        name: 'کوردلۆگز کۆر',
        platform: 'GitHub',
        detail: 'ڕێپۆزیتۆری فەرمی کلۆن بکە — سۆرس، فایلەکانی Docker Compose، و سکریپتەکانی دامەزراندن.',
      ...
      },
      {
        name: 'Docker Engine',
        platform: 'Linux / VPS',
        detail: 'Engine لەگەڵ پلاگینی Compose بۆ سێرڤەرەکان دابمەزرێنە. ڕێنمایی دیسترۆکەت شوێن بکەوە.',
        cta: 'دامەزراندنی Docker Engine',
      },
      {
        name: 'Git',
      ...
      },
      {
        name: 'WSL 2',
        platform: 'Windows',
        detail: 'لەسەر Windows لەلایەن Docker Desktopەوە داوا دەکرێت. ئەگەر دامەزراندنی Docker داوای کرد دایبمەزرێنە.',
        cta: 'دامەزراندنی WSL',
      },
    ],
  },
  ...
  features: [
    {
      ...
      body: 'M3U8، MP4، RTMP و زیاتر لە یەک پانێڵی ئۆپەرەیتەر بەڕێوە ببە کە بۆ تیمەکانی پەخش دروست کراوە.',
    },
    {
